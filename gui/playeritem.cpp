...
PlayerItem::PlayerItem(direction dir,short cardCount,QPointF centerPoint,QObject *parent) : QObject(parent)
{
    ...
    switch(dir){
    case direction::LEFT: specialCard = CardItem::specialCards::BLUE_HORIZONTAL; break;
    case direction::RIGHT: specialCard = CardItem::specialCards::BLUE_VERTICAL; break;
    case direction::TOP: specialCard = CardItem::specialCards::BLUE_HORIZONTAL; break;
    default: break;
    }
